...
set CLASSPATH=%APP_HOME%\lib\flywayjar-1.0-SNAPSHOT.jar;%APP_HOME%\lib\redshift-jdbc42-2.0.0.7.jar;%APP_HOME%\lib\flyway-core-7.13.0.jar;%APP_HOME%\lib\aws-lambda-java-log4j2-1.2.0.jar;%APP_HOME%\lib\aws-lambda-java-core-1.2.1.jar;%APP_HOME%\lib\aws-lambda-java-events-3.1.0.jar;%APP_HOME%\lib\aws-java-sdk-s3-1.12.45.jar;%APP_HOME%\lib\gson-2.8.7.jar;%APP_HOME%\lib\aws-java-sdk-kms-1.12.45.jar;%APP_HOME%\lib\aws-java-sdk-core-1.12.45.jar;%APP_HOME%\lib\joda-time-2.8.1.jar;%APP_HOME%\lib\jmespath-java-1.12.45.jar;%APP_HOME%\lib\log4j-core-2.13.2.jar;%APP_HOME%\lib\log4j-api-2.13.2.jar;%APP_HOME%\lib\httpclient-4.5.13.jar;%APP_HOME%\lib\commons-logging-1.2.jar;%APP_HOME%\lib\commons-codec-1.15.jar;%APP_HOME%\lib\ion-java-1.0.2.jar;%APP_HOME%\lib\jackson-annotations-2.12.3.jar;%APP_HOME%\lib\jackson-core-2.12.3.jar;%APP_HOME%\lib\jackson-dataformat-cbor-2.12.3.jar;%APP_HOME%\lib\jackson-databind-2.12.3.jar;%APP_HOME%\lib\httpcore-4.4.13.jar
